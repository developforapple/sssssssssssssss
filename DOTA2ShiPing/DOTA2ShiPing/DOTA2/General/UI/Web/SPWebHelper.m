...
//        }
        ...
        open();
//        if (willAlert) {
//            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"建议使用iOS9或更新系统" message:@"在iOS9及以上系统，我们将使用Safari浏览器在应用内打开目标网址。您可以安全的进行登录，登录状态不会丢失。" preferredStyle:UIAlertControllerStyleAlert];
//            [alert addAction:[UIAlertAction actionWithTitle:@"继续" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
//                open();
//                [[NSUserDefaults standardUserDefaults] setBool:YES forKey:k];
//            }]];
