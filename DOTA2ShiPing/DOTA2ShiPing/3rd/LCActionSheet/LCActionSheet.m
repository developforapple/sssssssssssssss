...
- (UIStatusBarStyle)preferredStatusBarStyle
{
    ...
    if ([root respondsToSelector:@selector(preferredStatusBarStyle)]) {
...
- (void)setupMainView
{
    ...
    self.effectView.alpha = .5f;
    self.effectView.frame = CGRectMake(0, 0, SCREEN_SIZE.width, SCREEN_SIZE.height);
...
- (void)show {
    ...
    [self.backWindow setRootViewController:self];
