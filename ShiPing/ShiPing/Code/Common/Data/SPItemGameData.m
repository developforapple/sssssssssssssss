...
- (void)createHeroes
{
    ...
    NSLog(@"创建英雄列表完成，共%d个英雄",heroArray.count);
...
- (void)save
{
    ...
    long long v = [[NSDate date] timeIntervalSince1970] * 1000 - 1010110203019LL;
    NSMutableDictionary *version = [[self version] mutableCopy];
    version[@"version"] = @(v);
    NSLog(@"数据版本：%@",version);
...
- (void)createZipFile
{
    ...
    BOOL suc = [SSZipArchive createZipFileAtPath:zipPath withFilesAtPaths:@[[self jsondataPath],[self dbPath]] withPassword:pwd];
